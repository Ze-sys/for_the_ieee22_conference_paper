...
the app should be used locally. Even when testing the provided models with the <span  style="color:red">larger datasets can give the server troubles, and the app may crash</span>. 
