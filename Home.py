...
<p>
This is an app built and used to train and test autoencoder models for the conference paper <a href="https://ieeexplore.ieee.org/document/9977351">Anomaly detection in complex data: a practical application when outliers are few</a>
. 
